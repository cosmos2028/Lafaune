...
<html>
    ...
    <script>
        ...
        function submitForm() {
            $.ajax({type:'POST', url: 'carnii.php', data:$('#ContactForm').serialize(), success: function(response) {
  ...
  <?php  
      /*on recupere toute la ligne de la table produit pour cat_code = 'car*/
      $reponse = $bdd->query("SELECT * FROM produit WHERE  cat_code = 'car' ");
...
<form autocomplete="off" method="POST" action=" carnii.php" id="ContactForm" onsubmit="return submitForm();">

...
<html>
    ...
    <script>
        ...
        function submitForm() {
            $.ajax({type:'POST', url: 'paysagess.php', data:$('#ContactForm').serialize(), success: function(response) {
  ...
  <?php  
      ...
      $reponse = $bdd->query("SELECT * FROM produit WHERE  cat_code = 'pay' ");
...
<form autocomplete="off" method="POST" action=" paysagess.php" id="ContactForm" onsubmit="return submitForm();">

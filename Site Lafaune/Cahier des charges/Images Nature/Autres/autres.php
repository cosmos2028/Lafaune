...
<html>
    ...
    <script>
        ...
        function submitForm() {
            $.ajax({type:'POST', url: 'autress.php', data:$('#ContactForm').serialize(), success: function(response) {
	...
	<?php  
      ...
      $reponse = $bdd->query("SELECT * FROM produit WHERE  cat_code = 'mam' ");
...
<form autocomplete="off" method="POST" action=" autress.php" id="ContactForm" onsubmit="return submitForm();">
